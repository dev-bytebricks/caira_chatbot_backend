...
@admin_config_router_protected.put("/", status_code=status.HTTP_200_OK)
...
@admin_config_router_protected.get("/", status_code=status.HTTP_200_OK, response_model=AdminConfigResponse)
