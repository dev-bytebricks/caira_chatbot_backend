        ...
        for message in zep_chat_history:
            if message.role == "User":
                ...
                if user_message_count == settings.FREE_PLAN_MSG_LIMIT:
                    yield "You have consumed all of your free messages. Subscribe to Ilexia in the side menu. You can access it by pressing the icon on the top left corner of the page."
                    return
